...
from barinex.services.indicator_evaluator import evaluate_indicators  # renamed module
from barinex.services.utils import resample_df  # if you moved resample to utils
...
def load_config() -> Dict:
    ...
    """
    path = Path(settings.project_root) / "config" / "indicator_settings.yml"
